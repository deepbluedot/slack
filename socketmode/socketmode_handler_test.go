...
import (
	...
	"github.com/deepbluedot/slack/slackevents"
)
...
func init_SocketmodeHandler() *SocketmodeHandler {
	...
	return &SocketmodeHandler{
		Client: &Client{
			log: log.New(os.Stderr, "deepbluedot/slack/socketmode", log.LstdFlags|log.Lshortfile),
		},
		EventMap:                       eventMap,
...
func TestSocketmodeHandler_Handle(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/deepbluedot/slack/socketmode.middleware",
		}, {
			...
			want: "github.com/deepbluedot/slack/socketmode.defaultmiddleware",
		},
	}
...
func TestSocketmodeHandler_HandleInteraction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/deepbluedot/slack/socketmode.middleware_interaction",
		}, {
...
func TestSocketmodeHandler_HandleEvents(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/deepbluedot/slack/socketmode.middleware_eventapi",
		}, {
			name: "Event do not Match any registered function",
			args: args{
				evt: Event{
...
func TestSocketmodeHandler_HandleInteractionBlockAction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/deepbluedot/slack/socketmode.middleware_interaction_block_action",
		}, {
			name: "Event do not Match any registered function",
			args: args{
				evt: Event{
...
func TestSocketmodeHandler_HandleSlashCommand(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/deepbluedot/slack/socketmode.middleware_slach_command",
		}, {
			name: "Event do not Match any registered function",
			args: args{
				evt: Event{
